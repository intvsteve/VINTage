...
namespace INTV.Core.Model.Program
{
    ...
    {
        /// <summary>
        /// Program is incompatible with LTO Flash! technology.
        /// </summary>
        Incompatible = FeatureCompatibility.Incompatible,

        /// <summary>
        /// Program uses no LTO Flash!-specific features.
        /// </summary>
        Tolerates = FeatureCompatibility.Tolerates,

        /// <summary>
        /// Program uses LTO Flash!-specific acceleration features if present.
        /// </summary>
        Enhances = FeatureCompatibility.Enhances,

        /// <summary>
        /// Program requires LTO Flash!-specific acceleration features.
        /// </summary>
        Requires = FeatureCompatibility.Requires,

        /// <summary>
        /// Program uses JLP save-data feature.
        /// </summary>
        ...
        /// <summary>
        /// Program uses bank switching to access additional device memory.
        /// </summary>
        ...
        /// <summary>
        /// Program uses LTO Flash!'s serial port capabilities.
        /// </summary>
        UsbPortEnhanced = 1 << LtoFlashFeaturesHelpers.UsbPortOffset, // 6

        /// <summary>
        /// Program requires LTO Flash!'s serial port capabilities.
        /// </summary>
        ...
        /// <summary>
        /// Program enables the LTO Flash! memory mapper.
        /// </summary>
    ...
    {
        /// <summary>
        /// The maximum size of a file in the LTO Flash file system in bytes.
        /// </summary>
        public const uint MaxFileSize = Rom.MaxROMSize;

        /// <summary>
        /// The maximum number of flash save data sectors that can be assigned on LTO Flash!.
        /// </summary>
        public const uint MaxFlashSaveDataSectorsCount = MaxFileSize / JlpFeaturesHelpers.BytesPerSector;

        /// <summary>
        /// The default compatibility mode for LTO Flash! features.
        /// </summary>
        ...
        /// <summary>
        /// The number of bits reserved for storing flash data sector count.
        /// </summary>
        ...
        /// <summary>
        /// Number of bits to shift to extract flash sector usage from feature bits.
        /// </summary>
        public const int SaveDataSectorOffset = UsbPortOffset + UsbPortFeatureBitCount; // 8

        /// <summary>
        /// The number of bits reserved to store how many save data sectors are used.
        /// </summary>
        public const int SaveDataSectorBits = 10;

        /// <summary>
        /// The number of bits to shift to extract whether LTO Flash memory mapping is enabled.
        /// </summary>
        public const int LtoFlashMemoryMappedOffset = SaveDataOffset + SaveDataSectorBits;
        ...
        /// Valid flags.
        /// </summary>
        public const LtoFlashFeatures ValidFeaturesMask = (LtoFlashFeatures)0x00FF;
        ...
        public static LuigiFeatureFlags ToLuigiFeatureFlags(this LtoFlashFeatures features)
        {
            ...
            luigiFeatureFlags |= (LuigiFeatureFlags)(((ulong)(features & SaveDataMask) >> (int)SaveDataOffset) << LuigiFeatureFlagsHelpers.JlpFlashMinimumSaveDataSectorsCountOffset);
