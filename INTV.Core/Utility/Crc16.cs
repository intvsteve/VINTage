...
{
    /// <summary>
    /// Provides methods to compute a 16-bit CRC value for a block of data.
    /// </summary>
    public static class Crc16
    {
        ...
        /// <summary>
        /// Updates a 16-bit CRC using the lookup table above.
        /// </summary>
        ...
        {
            return (ushort)((crc << 8) ^ Crc16Table[(crc >> 8) ^ data]);
        }

        /// <summary>
        /// Updates a 16-bit CRC on a block of 8-bit data.
        /// </summary>
        /// <param name="data">The data block for which to compute the CRC.</param>
        /// <param name="runningValue">The current CRC value.</param>
        /// <returns>The CRC value of the block of data.</returns>
        /// <remarks>The 16-bit CRC is set up as a left-shifting CRC with no inversions.</remarks>
        public static ushort OfBlock(byte[] data, ushort runningValue)
        {
            return OfBlock(data, data.Length, runningValue);
        }
        ...
        /// </summary>
        /// <param name="data">The data block for which to compute the CRC.</param>
        /// <param name="len">The length of the data block.</param>
        /// <param name="runningValue">The current CRC value.</param>
        /// <returns>The CRC value of the block of data.</returns>
        /// <remarks>The 16-bit CRC is set up as a left-shifting CRC with no inversions.</remarks>
