// <copyright file="GarbageCollect.cs" company="INTV Funhouse">
...
{
    /// <summary>
    /// Implements the command to instruct a Locutus device to perform incremental file system garbage collection.
    /// </summary>
    internal sealed class GarbageCollect : ProtocolCommand
    {
        /// <summary>
        ...
        private GarbageCollect()
            : base(ProtocolCommandId.GarbageCollect, DefaultResponseTimeout)
        {
        }

        /// <summary>
        /// Gets the instance of the GarbageCollect command.
        /// </summary>
        public static readonly GarbageCollect Instance = new GarbageCollect();
