...
namespace INTV.LtoFlash.Model
{
    ...
    public delegate bool FileSystemEntryComparer<T>(T lhs, T rhs, bool forceUpdate, out string failedCompareEntryName, out Exception error) where T : class, IGlobalFileSystemEntry;
    ...
    public delegate bool FileSystemEntryValidator<T>(T entry, Device targetDevice, bool forceUpdate, out string failedValidationEntryName, out Exception error) where T : class, IGlobalFileSystemEntry;
    ...
    public sealed class GatherDifferencesDescriptor<T> where T : class, IGlobalFileSystemEntry
    {
        ...
        /// <summary>
        /// Gets the ignore filter function to use when gathering differences.
        /// </summary>
        public Predicate<T> Ignore { get; private set; }
        ...
        private static bool AlwaysValid(T entry, Device targetDevice, bool forceUpdate, out string failedValidationEntryName, out Exception error)
        {
        ...
        private static bool NeverIgnore(T entry)
        {
            return false;
        }
    }
