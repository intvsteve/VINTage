...
namespace INTV.LtoFlash.View
{
    ...
    /// </summary>
    public partial class PromptToAddMenuItemsForNewRomsController : MonoMac.AppKit.NSWindowController
    {
        #region Constructors
        ...
        public PromptToAddMenuItemsForNewRomsController(IntPtr handle)
            : base(handle)
        {
            Initialize();
        }
