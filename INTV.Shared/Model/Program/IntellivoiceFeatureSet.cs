// <copyright file="IntellivoiceFeatureSet.cs" company="INTV Funhouse">
...
{
    /// <summary>
    /// Describes the set of features for the Intellivoice.
    /// </summary>
    public class IntellivoiceFeatureSet : ProgramFeatureSet<FeatureCompatibility>
    {
        /// <summary>
        /// The instance of the feature set.
        /// </summary>
        public static readonly IntellivoiceFeatureSet Data = new IntellivoiceFeatureSet();

        private static readonly Dictionary<FeatureCompatibility, string> FeatureImages = new Dictionary<FeatureCompatibility, string>()
        {
            { FeatureCompatibility.Incompatible, "ViewModel/Resources/Images/intellivoice_incompatible_16xLG.png" },
            { FeatureCompatibility.Tolerates, null },
            { FeatureCompatibility.Enhances, "ViewModel/Resources/Images/intellivoice_enhanced_16xLG.png" },
            { FeatureCompatibility.Requires, "ViewModel/Resources/Images/intellivoice_16xLG.png" },
        };
        ...
        {
            { FeatureCompatibility.Incompatible, Resources.Strings.IntellivoiceCompatibility_Incompatible_Tip },
            { FeatureCompatibility.Tolerates, null },
            { FeatureCompatibility.Enhances, Resources.Strings.IntellivoiceCompatibility_Enhanced_Tip },
            { FeatureCompatibility.Requires, Resources.Strings.IntellivoiceCompatibility_Required_Tip },
        };

        private static readonly Dictionary<FeatureCompatibility, OSImage> ImageCache = new Dictionary<FeatureCompatibility, OSImage>();

        private IntellivoiceFeatureSet()
            : base(FeatureCategory.Intellivoice)
        {
        }
