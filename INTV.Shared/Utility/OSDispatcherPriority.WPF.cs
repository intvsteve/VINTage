// <copyright file="OSDispatcherPriority.WPF.cs" company="INTV Funhouse">
...
{
    /// <summary>
    /// Priority for OS dispatcher tasks.
    /// </summary>
    public enum OSDispatcherPriority
    {
        /// <summary>
        /// Operations are processed after all other non-idle operations are completed.
        /// </summary>
        Background = System.Windows.Threading.DispatcherPriority.Background,
