// <copyright file="RomListSettingsPage.Mac.cs" company="INTV Funhouse">
...
namespace INTV.Shared.View
{
    ...
    /// </summary>
    public partial class RomListSettingsPage : MonoMac.AppKit.NSView, IFakeDependencyObject
    {
        #region Constructors
        ...
        public RomListSettingsPage(IntPtr handle)
            : base(handle)
        {
            Initialize();
        }
        ...
        public RomListSettingsPage(NSCoder coder)
            : base(coder)
        {
            Initialize();
        }
        ...
        internal RomListSettingsPageController Controller { get; set; }
