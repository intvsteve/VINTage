...
namespace INTV.Shared.View
{
    ...
    public partial class SerialPortSelectorDialog
    {
        ...
        public static SerialPortSelectorDialog Create(string title, string message, IEnumerable<string> ports, IEnumerable<string> disabledPorts, int baudRate)
        {
            return Create(title, message, ports, disabledPorts, null, null, baudRate, false);
        }
        ...
        /// <returns>A new instance of the dialog.</returns>
        public static SerialPortSelectorDialog Create(string title, string message, string selectedPort, IEnumerable<int> baudRates, int defaultBaudRate)
        {
            return Create(title, message, null, null, selectedPort, baudRates, defaultBaudRate, false);
        }
        ...
        /// <returns>A new instance of the dialog.</returns>
        public static SerialPortSelectorDialog Create(string title, string message, IEnumerable<string> ports, IEnumerable<string> disabledPorts, string selectedPort, IEnumerable<int> baudRates, int defaultBaudRate, bool checkPortAvailability)
        {
            var selectPortViewModel = new SerialPortSelectorViewModel(message, ports, disabledPorts, selectedPort, baudRates, defaultBaudRate, checkPortAvailability);
