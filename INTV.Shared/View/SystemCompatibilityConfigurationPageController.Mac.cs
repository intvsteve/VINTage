...
namespace INTV.Shared.View
{
    ...
    /// </summary>
    public partial class SystemCompatibilityConfigurationPageController : MonoMac.AppKit.NSViewController, IFakeDependencyObject
    {
        #region Constructors
        ...
        public SystemCompatibilityConfigurationPageController(IntPtr handle)
            : base(handle)
        {
            Initialize();
        }
        ...
        public override void AwakeFromNib()
        {
            var initializationData = new[] {
                new Tuple<NSPopUpButton, IList<ProgramFeatureImageViewModel>, ProgramFeatureImageViewModel>(IntellivisionIIPopUpButton, ViewModel.IntellivisionIIOptions, ViewModel.IntellivisionII),
                new Tuple<NSPopUpButton, IList<ProgramFeatureImageViewModel>, ProgramFeatureImageViewModel>(SuperVideoArcadePopUpButton, ViewModel.SuperVideoArcadeOptions, ViewModel.SuperVideoArcade),
                new Tuple<NSPopUpButton, IList<ProgramFeatureImageViewModel>, ProgramFeatureImageViewModel>(TutorvisionPopUpButton, ViewModel.TutorvisionOptions, ViewModel.Tutorvision)
            };
