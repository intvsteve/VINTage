...
namespace INTV.Shared.View
{
	public partial class RomFeaturesConfiguration
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget INTV.Shared.View.RomFeaturesConfiguration
			this.Name = "INTV.Shared.View.RomFeaturesConfiguration";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child INTV.Shared.View.RomFeaturesConfiguration.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child INTV.Shared.View.RomFeaturesConfiguration.ActionArea
