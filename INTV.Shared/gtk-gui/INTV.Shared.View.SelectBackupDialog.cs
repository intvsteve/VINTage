...
namespace INTV.Shared.View
{
	public partial class SelectBackupDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget INTV.Shared.View.SelectBackupDialog
			this.Name = "INTV.Shared.View.SelectBackupDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child INTV.Shared.View.SelectBackupDialog.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child INTV.Shared.View.SelectBackupDialog.ActionArea
