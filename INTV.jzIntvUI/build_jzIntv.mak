...
all: $(addprefix $(TARGET_DIR)/, bin/$(JZINTV_APP) $(JZINTV_SUPPORT_FILES))
...
clean:
	...
	rm -rf $(TARGET_DIR)/bin/$(JZINTV_APP) $(addprefix $(TARGET_DIR)/,$(JZINTV_SUPPORT_FILES))
	@echo

.PHONY: $(addprefix $(TARGET_DIR)/,$(JZINTV_SUPPORT_FILES))
