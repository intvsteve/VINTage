============================================================================
 LTO Flash! -- User Interface Software for Mac OS X
============================================================================
...
The LTO Flash! User Interface Software for Mac is compatible with
...
You will find LTO Flash.dmg - a disk image file. Double click it to
mount it if this does not happen automatically. This will open the
Finder window containing the necessary files.

Simply drag LtoFlash.app to a desired location. The Disk Image already
has a shortcut to the Applications folder on your Mac.

**TO RUN THE APP: Right Click and choose Open** the first time you run it.

Since the app is not published through the App Store, the first time you
run it, you must **right click** it and choose 'Open'. This is absolutely
necessary in the newest versions of Mac OS X.
  ...
  to be installed in order to function with your LTO Flash! hardware.
    ...
    2. FTDI Drivers - may be required to communicate with your LTO Flash!
       hardware on some versions of Mac OS X

  1. MONO Runtime
  ---------------
  The LTO Flash! User Interface Software for Mac is implemented using
  ...
  At this time, you only need the 32-bit Mac Package (pkg) release.
  ...
  the appropriate version included in the disk image.

  PRIOR TO INSTALLING ANY FTDI DRIVER SOFTWARE, first try to use your
  LTO Flash! Some versions of Mac OS X already have the necessary drivers.
  ...
  NOTE! Recent testing on Mac OS X 10.10 and later indicates that it is
        NOT NECESSARY to install any drivers from FTDI for communication
        with your LTO Flash!.
...
device and makes it safer to unplug it from your system.
  ...
  !!!! NOTE NOTE NOTE !!!!
  ------------------------
  During testing, we have found that, due to problems in the FTDI driver
  software on Mac OS X, unplugging your LTO Flash! device from your
  computer may cause the system to crash and restart. This problem occurs
  rarely, and even less frequently if you either quit the application
  software first, or disconnect from your LTO Flash! by choosing:
  ...
  2. Computer does not recognize your LTO Flash!
     ...
     REMEDY: The remedy depends on the problem, but troubleshooting this
             problem is simple enough.
               ...
               d) If restarting the application software still results in no
                  device being located, use the "Console" application on your
                  Mac. To start it, use Spotlight (Cmd + <spacebar>) and type
                    Console
                  After launching Console, plug in your LTO Flash! In the
                  Console application, you should see a line of text similar
                  to the following appear shortly after plugging in your
                  device:
                    5/3/15 1:04:24.000 PM kernel[0]: FTDIUSBSerialDriver:        0  4036015 start - ok
                  If you do not, then the FTDI VCP driver may be
                  malfunctioning, you have a bad USB cable, or your device
                  itself is damaged. It is most likely that the FTDI VCP
                  driver is not working.

                  Restart your Mac and try again.
               e) If you have restarted your computer and there are no
                  messages showing that the FTDI USB Serial Driver is
                  ...
                  ports if possible.
               f) If all else fails, it's possible that you've found a bug
